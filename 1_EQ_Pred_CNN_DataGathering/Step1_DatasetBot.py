...
m = 1
while y<year:
    TimeStart  = str(y) + "-" + str(m) + "-" + str(day) + " " + "00:00:00"
    if m+1 <= 12:
        TimeFinish = str(y) + "-" + str(m+1) + "-" + str(day) + " " + "00:00:00"
    else:
        m = 1
        y += 1
        TimeFinish = str(y) + "-" + str(m) + "-" + str(day) + " " + "00:00:00"
    ...
    # click button - Search
    browser.find_element_by_xpath('//*[@id="fdsn-submit"]').click()
    # termination
    time.sleep(15)
    browser.quit()
